...
namespace V2RayW
{
    public class PortableSettingsProvider : SettingsProvider
    {
        ...
        public PortableSettingsProvider() : this(DefaultDirectory,DefaultFileName)
        {
        }
        public PortableSettingsProvider(string folderName,string fileName)
        {
            _fileName = Path.Combine(folderName,fileName);
        }
